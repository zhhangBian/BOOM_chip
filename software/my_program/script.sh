...
${GCC_BIN}/loongarch32r-linux-gnusf-gcc ${CFLAGS} $1 -o main.elf -I../../toolchains/loongarch32r-linux-gnusf*/lib/gcc/loongarch32r-linux-gnusf/8.3.0/include -I../../toolchains/system_newlib/loongarch32-unknown-elf/include ${LFLAGS}
